...
namespace FastData.Context
{
    public class DataContext : IDisposable
    {
        ...
        private void Navigate<T>(DataReturn<T> model, ConfigModel config, bool isPage) where T : class, new()
        {
            ...
            {
                BaseAop.AopException(ex, $"to List tableName:{typeof(T).Name}", config, AopType.Navigate);
        ...
        public DataContext(string key = null)
        {
            ...
            {
                BaseAop.AopException(ex, $"DataContext :{key}",config,AopType.DataContext);
        ...
        public DataReturn<T> GetList<T>(DataQuery item) where T : class,new()
        {
            ...
            {
                BaseAop.AopException(ex, $"to List tableName:{typeof(T).Name}",config, AopType.Query_List_Lambda);
        ...
        public DataReturnDyn GetDyns(DataQuery item)
        {
            ...
            {
                BaseAop.AopException(ex, $"to Dyns tableName:{string.Join(",", item.Table.ToArray())}", config, AopType.Query_Dyn_Lambda);
                if (string.Compare(config.SqlErrorType, SqlErrorType.Db, true) == 0)
        ...
        public DataReturn GetPage(DataQuery item, PageModel pModel)
        {
            ...
            {
                BaseAop.AopException(ex, "to Page",config, AopType.Query_Page_Lambda_Dic);
        ...
        public DataReturnDyn GetDynPage(DataQuery item, PageModel pModel)
        {
            ...
            {
                BaseAop.AopException(ex, "to Page ", config, AopType.Query_Page_Lambda_Dyn);
                if (config.SqlErrorType == SqlErrorType.Db)
        ...
        public DataReturn GetPageSql(PageModel pModel, string sql, DbParameter[] param,bool isAop=true)
        {
            ...
            {
                BaseAop.AopException(ex, "to Page sql",config, AopType.Query_Page_Lambda_Dic);
        ...
        public DataReturn GetJson(DataQuery item)
        {
            ...
            try
            {
                ...
                BaseAop.AopBefore(null, sql.ToString(), param?.ToList(), config, true,AopType.Query_Json_Lambda);
            ...
            {
                BaseAop.AopException(ex, "to Json",config, AopType.Query_Json_Lambda);
        ...
        public DataReturn GetCount(DataQuery item)
        {
            ...
            try
            {
                ...
                BaseAop.AopAfter(null, sql.ToString(), param?.ToList(), config, true, AopType.Query_Json_Lambda, result.Count);

                return result;
            }
            catch (Exception ex)
            {
                BaseAop.AopException(ex, "to Count",config, AopType.Query_Json_Lambda);
        ...
        public DataReturn<T> ExecuteSql<T>(string sql, DbParameter[] param=null) where T : class,new()
        {
            ...
            {
                BaseAop.AopException(ex, $"ExecuteSql tableName:{typeof(T).Name}",config, AopType.Execute_Sql_Model);
        ...
        public DataReturn ExecuteSqlList(string sql, DbParameter[] param=null,bool isLog=false,bool isAop=true)
        {
            ...
            try
            {
                ...
                if(isAop)
                    BaseAop.AopBefore(null, sql.ToString(), param?.ToList(), config, true,AopType.Execute_Sql_Dic);
            ...
            {
                BaseAop.AopException(ex, "Execute Sql",config, AopType.Execute_Sql_Dic);
        ...
        public DataReturn ExecuteSqlList(System.Type type, string sql, DbParameter[] param = null, bool isLog = false, bool isAop = true)
        {
            ...
            {
                BaseAop.AopException(ex, "Excute Sql", config, AopType.Execute_Sql_Model);
                result.writeReturn.IsSuccess = false;
        ...
        public DataReturn GetDic(DataQuery item)
        {
            ...
            {
                BaseAop.AopException(ex, "to Dic",config, AopType.Query_Dic_Lambda);
        ...
        public DataReturn GetDataTable(DataQuery item)
        {
            ...
            {
                BaseAop.AopException(ex, "to DataTable",config, AopType.Query_DataTable_Lambda);
        ...
        public DataReturn<T> Delete<T>(Expression<Func<T, bool>> predicate, bool isTrans = false) where T : class, new()
        {
            ...
            {
                BaseAop.AopException(ex, $"Delete by Lambda tableName：{typeof(T).Name}", config, AopType.Delete_Lambda);
        ...
        public DataReturn<T> Delete<T>(T model, bool isTrans = false) where T : class, new()
        {
            ...
            {
                BaseAop.AopException(ex, $"Delete by Primary Key tableName：{typeof(T).Name}",config, AopType.Delete_PrimaryKey, model);
        ...
        private DataReturn Delete(object model, NavigateModel navigate)
        {
            ...
            {
                BaseAop.AopException(ex, $"tableName: {model.GetType().Name}, NavigateDelete:{ex.Message}, MemberName:{navigate.MemberName}", config, AopType.Navigate_Delete, model);
        ...
        public DataReturn<T> Update<T>(T model, Expression<Func<T, bool>> predicate, Expression<Func<T, object>> field = null, bool isTrans = false) where T : class, new()
        {
            ...
            {
                BaseAop.AopException(ex, $"Update by Lambda tableName:{typeof(T).Name}",config, AopType.Update_Lambda, model);
        ...
        public DataReturn<T> Update<T>(T model, Expression<Func<T, object>> field = null, bool isTrans = false) where T : class, new()
        {
            ...
            {
                BaseAop.AopException(ex, $"Update by Primary Key tableName:{typeof(T).Name}",config, AopType.Update_PrimaryKey, model);
        ...
        private DataReturn Update(object model, NavigateModel navigate)
        {
            ...
            {
                BaseAop.AopException(ex, $"tableName: {model.GetType().Name}, NavigateUpdate:{ex.Message}, MemberName:{navigate.MemberName}", config, AopType.Navigate_Update, model);
        ...
        public DataReturn<T> UpdateList<T>(List<T> list, Expression<Func<T, object>> field = null) where T : class, new()
        {
            ...
            {
                BaseAop.AopException(ex, $"Update List tableName:{typeof(T).Name}",config, AopType.UpdateList, list);
        ...
        public DataReturn<T> Add<T>(T model, bool isTrans = false, Expression<Func<T, object>> notAddField = null) where T : class, new()
        {
            ...
            {
                BaseAop.AopException(ex, $"Add tableName: typeof(T).Name",config, AopType.Add,model);
        ...
        private DataReturn Add(object model, NavigateModel navigate)
        {
            ...
            {
                BaseAop.AopException(ex, $"tableName: {model.GetType().Name}, NavigateAdd:{ex.Message}, MemberName:{navigate.MemberName}", config, AopType.Navigate_Add, model);
        ...
        public DataReturn<T> AddList<T>(List<T> list, bool IsTrans = false, bool isLog = true) where T : class, new()
        {
            ...
            {
                BaseAop.AopException(ex, $"Add List tableName:{typeof(T).Name}",config,AopType.AddList,list);
        ...
        private DataReturn AddList(object model, NavigateModel navigate)
        {
            ...
            {
                BaseAop.AopException(ex, $"Add List tableName:{navigate.PropertyType.Name}", config, AopType.Navigate_AddList, model);
        ...
        internal DataReturn ExecuteSql(string sql, DbParameter[] param, AopType type, bool isTrans = false, bool isLog = false, bool IsProcedure = false,bool isAop=true)
        {
            ...
            try
            {
                ...
                if (isAop)
                    BaseAop.AopAfter(null, sql, param?.ToList(), config, false, AopType.Execute_Sql_Bool, result.writeReturn);
            }
            catch (Exception ex)
            {
                BaseAop.AopException(ex, "Excute Sql",config, AopType.Execute_Sql_Bool);
        ...
        public DataReturn ExecuteDDL(string sql, DbParameter[] param, bool isLog = false, bool isAop = true)
        {
            ...
            {
                BaseAop.AopException(ex, "Execute DDL", config, AopType.Execute_Sql_DDL);
