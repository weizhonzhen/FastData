...
namespace FastData.Repository
{
    public class FastRepository : IFastRepository
    {
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public List<T> ExecuteSql<T>(string sql, DbParameter[] param, DataContext db = null, string key = null) where T : class, new()
        {
            ConfigModel config = null;
            var result = new DataReturn<T>();
            var stopwatch = new Stopwatch();
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public async Task<List<T>> ExecuteSqlAsy<T>(string sql, DbParameter[] param, DataContext db = null, string key = null) where T : class, new()
        {
            return await Task.Run(() =>
            {
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public Lazy<List<T>> ExecuteLazySql<T>(string sql, DbParameter[] param, DataContext db = null, string key = null) where T : class, new()
        {
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public async Task<Lazy<List<T>>> ExecuteLazySqlAsy<T>(string sql, DbParameter[] param, DataContext db = null, string key = null) where T : class, new()
        {
            return await Task.Run(() =>
            {
                return new Lazy<List<T>>(() => ExecuteSql<T>(sql, param, db, key));
