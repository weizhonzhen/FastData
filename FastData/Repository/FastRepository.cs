...
namespace FastData.Repository
{
    ...
    public class FastRepository<T> : IFastRepository<T> where T : class, new()
    {
        ...
        /// <param name="IsTrans">是否事务</param>
        /// <returns></returns>
        public Task<WriteReturn> AddListAsy(List<T> list, string key = null, bool IsTrans = false, bool isLog = true)
        {
            return Task.Run(() =>
            {
                return AddList(list, key, IsTrans, isLog);
            });
        }
        #endregion
        ...
        /// <param name="notAddField">不需要增加的字段</param>
        /// <returns></returns>
        public Task<WriteReturn> AddAsy(T model, DataContext db = null, string key = null, bool isOutSql = false)
        {
            return Task.Run(() =>
            {
                return Add(model, db, key, isOutSql);
            });
        }
        #endregion
        ...
        /// <param name="IsTrans">是否事务</param>
        /// <returns></returns>
        public Task<WriteReturn> DeleteAsy(Expression<Func<T, bool>> predicate, DataContext db = null, string key = null, bool isOutSql = false)
        {
            return Task.Run(() =>
            {
                return Delete(predicate, db, key, isOutSql);
            });
        }
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        public Task<WriteReturn> UpdateAsy(T model, DataContext db = null, string key = null, bool isTrans = false, bool isOutSql = false)
        {
            return Task.Run(() =>
            {
                return Delete(model, db, key, isOutSql);
            });
        }
        #endregion
        ...
        /// <param name="field">需要修改的字段</param>
        /// <returns></returns>
        public Task<WriteReturn> UpdateAsy(T model, Expression<Func<T, bool>> predicate, Expression<Func<T, object>> field = null, DataContext db = null, string key = null, bool isOutSql = false)
        {
            return Task.Run(() =>
            {
                return Update(model, predicate, field, db, key, isOutSql);
            });
        }
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        public Task<WriteReturn> UpdateAsy(T model, Expression<Func<T, object>> field = null, DataContext db = null, string key = null, bool isTrans = false, bool isOutSql = false)
        {
            return Task.Run(() =>
            {
                return Update(model, field, db, key, isTrans, isOutSql);
            });
        }
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        public Task<WriteReturn> UpdateListAsy(List<T> list, Expression<Func<T, object>> field = null, DataContext db = null, string key = null, bool isOutSql = false)
        {
            return Task.Run(() =>
            {
                return UpdateList(list, field, db, key, isOutSql);
            });
        }
        #endregion
